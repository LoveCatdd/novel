...
const BoxList = () => {
    ...
    const init = async () => {
        ...
        try {
            const resp = await authAxios("get", `http://localhost:8088/api/v1/watch/watch-next?id=${userStore.uid}`,{});
...
export const NextPage = () => {
  return (
    <Box>
        <Typography sx={{color: 'white', fontSize: '36px', fontWeight: 'bold'}}>稍后阅读</Typography>
        <BoxList />
    </Box>
  )
}
